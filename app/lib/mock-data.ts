...
export const MOCK_PROPOSALS = [
  {
    ...
    summary: 'Corredor verde con ciclovía protegida y arbolado nativo a lo largo de 2km de Av. del Libertador.',
    status: 'public',
    layer: 'meso',
    tags: ['movilidad', 'verde', 'ciclovia'],
  ...
  },
  {
    ...
    summary: 'Plaza multiuso con juegos inclusivos, calistenia, ajedrez y wifi público.',
    status: 'public',
    layer: 'micro',
    tags: ['espacio-publico', 'recreacion', 'accesibilidad'],
  ...
  },
  {
    ...
    summary: 'Red de estaciones de carga solar para bicicletas eléctricas con app y monitoreo.',
    status: 'public',
    layer: 'meso',
    tags: ['movilidad', 'energia-renovable', 'tecnologia'],
  ...
  },
  {
    ...
    summary: 'Ampliación de veredas y mejora de accesibilidad en calle Florida.',
    status: 'public',
    layer: 'meso',
    tags: ['peatonal', 'accesibilidad', 'comercio'],
  ...
  },
  {
    ...
    summary: 'Agricultura urbana comunitaria con riego por goteo y talleres educativos.',
    status: 'public',
    layer: 'micro',
    tags: ['agricultura-urbana', 'sustentabilidad', 'educacion'],
