-- ARENA - Insert 20 Spanish Proposals
-- Run this in Supabase Studio SQL Editor to populate database

-- Insert 20 Spanish proposals for Buenos Aires (Núñez area)
INSERT INTO proposals (id, title, summary, body, geom, layer, category, tags, status, author_id, created_at, updated_at) VALUES
...
('prop-3', 'Renovación Biblioteca Municipal Núñez', 'Modernizar biblioteca con tecnología actualizada y espacios de estudio ampliados', 'Renovar y modernizar la biblioteca municipal de Núñez con tecnología actualizada, espacios de estudio ampliados, sala de lectura infantil y características mejoradas de accesibilidad para todos los miembros de la comunidad. WiFi gratuito y aire acondicionado.', '{"type":"Point","coordinates":[-58.462,-34.543]}'::jsonb, 'micro', 'social', ARRAY['cultura', 'educación', 'accesibilidad'], 'published', 'demo', NOW(), NOW()),
...
('prop-7', 'Corredor Verde Cantilo', 'Forestación y embellecimiento de Av. Cantilo con 200 árboles nativos', 'Proyecto de forestación urbana en Av. Cantilo con plantación de 200 árboles nativos (tipa, jacarandá, ceibo), ampliación de veredas, incorporación de bicicleteros y mobiliario urbano sustentable. Reducirá la temperatura ambiente en verano.', '{"type":"Point","coordinates":[-58.461,-34.548]}'::jsonb, 'meso', 'green', ARRAY['forestación', 'medio ambiente', 'espacio público'], 'published', 'demo', NOW(), NOW()),
...
('prop-11', 'Mirador Panorámico Costanera Norte', 'Construcción de mirador elevado con vistas al Río de la Plata', 'Construir mirador panorámico de madera y acero en la Costanera Norte con plataforma elevada a 8 metros, telescopios públicos, cartelería informativa sobre biodiversidad del río, y área de descanso con sombra. Acceso universal por rampa.', '{"type":"Point","coordinates":[-58.456,-34.540]}'::jsonb, 'micro', 'green', ARRAY['turismo', 'espacio público', 'naturaleza'], 'published', 'demo', NOW(), NOW()),
...
('prop-14', 'Gimnasio Municipal al Aire Libre', 'Instalación de equipamiento deportivo gratuito en Parque Saavedra', 'Montar gimnasio al aire libre en Parque Saavedra con 15 estaciones de ejercicio (barras, paralelas, banco de abdominales, elíptica, etc.), piso de caucho reciclado, pérgola con paneles solares e iluminación nocturna. Clases gratuitas 3 veces por semana.', '{"type":"Point","coordinates":[-58.462,-34.547]}'::jsonb, 'micro', 'social', ARRAY['deporte', 'salud', 'espacio público'], 'published', 'demo', NOW(), NOW()),
...
('prop-17', 'Red de Bebederos Públicos Sustentables', 'Instalación de 25 bebederos con filtro UV para reducir consumo de plástico', 'Instalar red de 25 bebederos públicos con sistema de filtrado UV y refrigeración solar en parques, plazas y paradas de colectivo. Reducirá consumo de botellas plásticas en 50.000 unidades anuales. App móvil mostrará ubicaciones.', '{"type":"Point","coordinates":[-58.461,-34.546]}'::jsonb, 'meso', 'infrastructure', ARRAY['sustentabilidad', 'agua', 'plástico'], 'published', 'demo', NOW(), NOW()),
...
SELECT id, title, geom IS NOT NULL as has_geom, category, layer FROM proposals ORDER BY created_at DESC LIMIT 20;
